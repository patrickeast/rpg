...
var playground = {
    ...
    makeArena: function () {
        ...
        $(".characterSelectionArea div.character").click(playground.characterSelection);
        $(".characterSelectionArea").on("click", "div.character", playground.characterSelection);
        if ($(".characterSelectionArea").on("click", function () {
            console.log("Click.");
        }));
